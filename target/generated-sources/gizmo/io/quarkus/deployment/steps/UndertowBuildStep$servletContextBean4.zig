// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean4
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean4#deploy_0
    RETURN
    ** label2
